...
<!-- Page d'images créée par Arkalium, merci de respecter mon travail. -->
...
<center><img src="/image_data/images.gif"></center>
...
<br \>Derni&egrave;re mise &agrave; jour des images: <?PHP include("./template/updatenews.php"); ?>
<br \>Lien utile: <a href="/articles_topstory.php">Gallery Top Story
</center>
        ...
        if(in_array($ext, $valide_extensions))
        {
            echo '
                <div style="float:right; width:'.$image_largeur.'px; margin-right:10px">
                   <br \> <a href="/'.$test_Fichier.'" target="_blank"><img src="'.$test_Fichier.'" style="'.$image_largeur.'px" /><img src="/image_data/save.png" align="middle" /></a>
                </div>';
        }
    }
}
